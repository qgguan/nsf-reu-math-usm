...
| **WORK - HDD**    | `/work/hdd/<account>/$USER` | **Computation, Storage area.** For datasets, models, and job I/O. Large quota.              |
...
This script, named `job.slurm`, is provided in the repo.
